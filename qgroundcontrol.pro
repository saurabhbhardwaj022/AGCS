...
TEMPLATE = app
QGCROOT  = $$PWD
android: QT_ANDROID_PACKAGE_SOURCE_DIR = $$PWD/android
QML_IMPORT_PATH += $$PWD/src/QmlControls
CONFIG += absolute_paths
NDK_ROOT = C:/android/ndk/21.3.6528147
#
...
QGC_APP_NAME        = "Agcs"
QGC_ORG_NAME        = "avplinternational.com"
QGC_ORG_DOMAIN      = "avplinternation.com"
QGC_APP_DESCRIPTION = "GCS by AVPL R&D Team"
QGC_APP_COPYRIGHT   = "Copyright (C) 2025 AVPL INTERNATIONAL. All rights reserved."
...
CustomBuild {
    ...
    DEFINES += QGC_APPLICATION_NAME=\"\\\"AGCS\\\"\"
    DEFINES += QGC_ORG_NAME=\"\\\"Avplinternational.com\\\"\"
    DEFINES += QGC_ORG_DOMAIN=\"\\\"org.avpl\\\"\"
    RESOURCES += \
