...
Rectangle {
    ...
    property string __lastLanguageValue: ""
                    ...
                    Rectangle {
                        ...
                        Item {
                            ...
                            GridLayout {
                                ...
                                MessageDialog {
                                    id: restartMessage
                                    title: qsTr("Language Changed")
                                    text: qsTr("Please restart the app to apply the new language setting.")
                                ...
                                FactComboBox {
                                    ...
                                    onCurrentIndexChanged: {
                                           var current = QGroundControl.settingsManager.appSettings.qLocaleLanguage.rawValue
                                           if (__lastLanguageValue !== "" && current !== __lastLanguageValue) {
                                               restartMessage.visible = true
                                           }
                                           __lastLanguageValue = current
                                       }

                                       Component.onCompleted: {
                                           __lastLanguageValue = QGroundControl.settingsManager.appSettings.qLocaleLanguage.rawValue
                                       }
                                }
